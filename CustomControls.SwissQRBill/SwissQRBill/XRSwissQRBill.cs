...
namespace CustomControls.SwissQRBill {
    [ToolboxItem(true)]
    [ToolboxSvgImage("CustomControls.SwissQRBill.Resources.SwissQRBillToolboxSvgImage.svg,CustomControls.SwissQRBill")]
    [XRDesigner("CustomControls.Design.SwissQRBill.XRSwissQRBillDesigner, CustomControls.Design")]
    [Designer("CustomControls.Design.SwissQRBill._XRSwissQRBillDesigner, CustomControls.Design")]
    [XRToolboxSubcategory(0, 7)]
    [DefaultBindableProperty(nameof(StringData))]
#if NET452
    [ToolboxBitmap("CustomControls.SwissQRBill.Resources.SwissQRBillToolboxImage.bmp,CustomControls.SwissQRBill")]
#endif
    public partial class XRSwissQRBill : XRControl {
        ...
        [XtraSerializableProperty(XtraSerializationVisibility.Hidden)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public override DXFont Font { get => base.Font; set => base.Font = value; }
        ...
        [Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
        public override event DevExpress.XtraReports.UI.ChangeEventHandler SizeChanged { add { } remove { } }
